...
import {
  ...
  describe('common.service', () => {
    beforeEach(() => {
        // FIX: The tests are failing because the mock for `fetch` is incomplete.
        // We need to provide a more complete mock that includes the `ok`, `status`, and `statusText` properties.
